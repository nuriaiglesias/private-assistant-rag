...
\midrule
D: Orquestador + Híbrido + Reranker & 25 & 0.160 & 0.042 & \textit{(pendiente)} \\
\bottomrule
\multicolumn{5}{l}{\footnotesize BERTScore pendiente de la siguiente ejecución completa con el flag de BERTScore activado.}
\end{tabular}

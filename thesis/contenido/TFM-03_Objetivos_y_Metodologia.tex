...
\begin{enumerate}
    ...
    \item \textbf{Implementar} una variante mejorada del componente RAG mediante una estrategia de recuperación híbrida y \textit{reranking}.
    ...
    \item \textbf{Analizar} las fortalezas, limitaciones y posibles líneas de mejora de la solución propuesta en el contexto de asistentes institucionales privados basados en RAG y uso de herramientas.
\end{enumerate}
...
En este caso, el trabajo no consiste únicamente en desarrollar un prototipo funcional, sino también en analizar comparativamente el comportamiento de distintas configuraciones del componente RAG. 
...
\subsection{Sprint 5: implementación de la mejora del componente RAG}

El cuarto sprint estará orientado a la principal aportación experimental del TFM. 
En esta etapa se implementará una variante mejorada del componente RAG basada en recuperación híbrida y \textit{reranking}, manteniendo la posibilidad de compararla con el \textit{baseline} definido anteriormente.
